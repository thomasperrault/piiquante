...
const likeCtrl = require('../controllers/like'); //Controleur d'association des différentes routes
...
router.post('/:id/like', auth, multer, likeCtrl.likeDislikeSauce); //Définit le statut "like"
